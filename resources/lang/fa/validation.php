...
return array(
    ...
    */
    ...
    "between"          => array(
        ...
        "string"  => ":attribute باید بین :min و :max کاسایت مار باشد.",
    ...
    "max"              => array(
        ...
        "string"  => ":attribute نباید بیشتر از :max کاسایت مار باشد.",
    ...
    "min"              => array(
        ...
        "string"  => ":attribute نباید کمتر از :min کاسایت مار باشد.",
    ...
    "size"             => array(
        ...
        "string"  => ":attribute باید برابر با :size کاسایت مار باشد.",
